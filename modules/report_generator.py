...
def clean_ssl_info(ssl_info):
    ...
    cleaned["Valid From"] = ssl_info.get("valid_from", "N/A")

    cleaned["Valid Until"] = ssl_info.get("valid_until", "N/A")

    cleaned["Remaining"] = str(ssl_info.get("days_remaining", "N/A")) + " Days"
...
def generate_report(domain, scan_data):
    ...
    filename = domain.replace(".", "_") + "_report.html"
    ...
    ssl = clean_ssl_info(scan_data["ssl_information"])
...
"""
    ...
    html += ", ".join(scan_data["technology_information"]["server"])
